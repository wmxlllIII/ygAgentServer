...
import com.dmy.ygagentserver.module.user.repository.LocationRepository;
import com.dmy.ygagentserver.module.user.repository.SchoolRepository;
...
public class SchoolServiceImpl implements SchoolService {
    ...
    @Override
    public List<SearchSchoolRespDTO> searchSchool(SearchSchoolReqDTO req) {
    ...
    @Override
    public BindSchoolRespDTO bindSchool(BindSchoolReqDTO req) {
        ...
        return new BindSchoolRespDTO(true, "绑定成功");
    }

    @Override
    public List<GetLocationRespDTO> getLocations(GetLocationReqDTO req) {
